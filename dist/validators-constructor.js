...
function validatorWrapper(validators, name, validator) {
    return function (value, options) {
        ...
        var simpleArgsFormat = validatorObj[SIMPLE_ARGS_FORMAT] || validatorAliasObj[SIMPLE_ARGS_FORMAT] || validators[SIMPLE_ARGS_FORMAT];
        ...
        if (options.hasOwnProperty(arg) && !simpleArgsFormat) {
...
function addValidator(name, validator, params) {
    ...
    if (typeof validator === 'string') {
        ...
        validate = function validate(value /*arg, options*/) {
            ...
            var simpleArgsFormat = _this2[name][SIMPLE_ARGS_FORMAT] || _this2[SIMPLE_ARGS_FORMAT];
            var options = !simpleArgsFormat && isPlainObject(arg2) ? arg2 : {};
            // let options = arg2;

            if (arg1 != null && typeof arg1 !== 'boolean') {
                if (isPlainObject(arg1) || simpleArgsFormat) {
                    options = arg1;
                } else {
